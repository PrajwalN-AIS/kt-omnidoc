...
MODEL_NAME  = "aisquared/bolt-vl-v3"
...
OUTPUT_DIR  = "/project/LNUN5155_1759/personal_workspaces/SHETTYV3468/OmniDocBench/predictions"
...
def strip_thinking(text):
    """Remove thinking block (Qwen3 chain-of-thought).
    Model outputs: [reasoning text]</think>\n\n[actual answer]
...
for page in tqdm(pages, desc="Inference"):
    ...
    # output .md filename matches image basename (without extension)
