...
OUTPUT_DIR  = "/project/LNUN5155_1759/personal_workspaces/SHETTYV3468/OmniDocBench/predictions_qwen35"

os.makedirs(OUTPUT_DIR, exist_ok=True)

PROMPT = r"""Convert this document page image to Markdown format.
